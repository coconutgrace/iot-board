...
export const UPDATED_FETCH_REPLACE_DATA = "UPDATED_FETCH_REPLACE_DATA";
...
export const PUBLISHED_DATASOURCE_PLUGIN = "PUBLISHED_DATASOURCE_PLUGIN";
export const PUBLISHED_WIDGET_PLUGIN = "PUBLISHED_WIDGET_PLUGIN";
export const STARTED_LOADING_PLUGIN_FROM_URL = "STARTED_LOADING_PLUGIN_FROM_URL";

// Modal
export const SHOW_MODAL = "SHOW_MODAL";
export const HIDE_MODAL = "HIDE_MODAL";
export const MODAL_ADD_ERROR = "MODAL_ADD_ERROR";
export const MODAL_DELETE_ERROR = "MODAL_DELETE_ERROR";
